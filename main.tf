...
variable "params" {
  default = [
   ...
   ###
    ...
    { name = "roboshop.prod.cart.catalogue_host", value = "catalogue-prod.rdevopsb73.online", type = "String" },
    { name = "roboshop.prod.cart.catalogue_port", value = "8080", type = "String" },
    { name = "roboshop.prod.catalogue.mongo", value = "true", type = "String" },
    { name = "roboshop.prod.payment.cart_host", value = "cart-prod.rdevopsb73.online", type = "String" },
    { name = "roboshop.prod.payment.cart_port", value = "8080", type = "String" },
    { name = "roboshop.prod.payment.user_host", value = "user-dev.rdevopsb73.online", type = "String" },
